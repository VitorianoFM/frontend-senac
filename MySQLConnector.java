...
public class MySQLConnector {
    ...
    public static Connection conectar() {
        ...
        String mysqlDb = "db_mysql_connector"; // Nome do banco de dados a ser conectado.
        String mysqlUser = "root"; // Usuário do banco de dados.
        String msqlPassword = "senac@02"; // Senha do banco de dados.
        String mysqlPort = "3306"; // Porta padrão do MySQL.
        // String de conexão JDBC com o banco de dados MySQL.
        String mysqlUrl = "jdbc:mysql://" + mysqlHost + ":" + mysqlPort + "/" + mysqlDb + "?user=" + mysqlUser + "&password=" + msqlPassword;
        Connection conn = null; // Objeto de conexão que será retornado.
        
        try {
            // Carrega a classe do driver JDBC do MySQL e cria uma variável.
            Class.forName("com.msql.cj.jdbc.Drive").newInstance();
